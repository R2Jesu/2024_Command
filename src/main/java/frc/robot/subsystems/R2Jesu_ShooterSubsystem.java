...
public class R2Jesu_ShooterSubsystem extends SubsystemBase {
  ...
  private CANSparkMax topMotor = new CANSparkMax(11, MotorType.kBrushless);
  private RelativeEncoder topMotorEncoder = topMotor.getEncoder();
  private CANSparkMax bottomMotor = new CANSparkMax(10, MotorType.kBrushless);
  private RelativeEncoder bottomMotorEncoder = bottomMotor.getEncoder();
  private CANSparkMax indexerMotor = new CANSparkMax(9, MotorType.kBrushless);
  ...
  private CANSparkMax intakeGreenMotor = new CANSparkMax(13, MotorType.kBrushless);
